 ...
 * ALL RIGHTS RESERVED
*/ 
/*   $RCSfile: XmP.h,v $ $Revision: 1.152 $ $Date: 92/07/22 20:55:40 $ */
/*
...
#undef XtIsRealized
#endif
#define XtIsRealized(widget) (XtIsWidget(widget)                              \
		             ? ((Widget)(widget))->core.window                \
		             : ((Object)(widget))->object.parent->core.window)
...
#define XmINVALID_DIMENSION ((Dimension) 0xFFFF)
...
enum{	XmCASCADE_BUTTON_BIT = 1,	XmCASCADE_BUTTON_GADGET_BIT,
	...
	XmPANED_WINDOW_BIT,		XmVENDOR_SHELL_BIT, /* UNUSED */
...
#if defined(__STDC__) && __STDC__ && !defined(UNIXCPP)
