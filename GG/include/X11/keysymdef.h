...
#define XK_Home		        0xFF31
#define XK_Left			0xFF32	/* Move left, left arrow */
#define XK_Up			0xFF33	/* Move up, up arrow */
#define XK_Right		0xFF34	/* Move right, right arrow */
#define XK_Down			0xFF35	/* Move down, down arrow */
