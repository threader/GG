...
/* some redefined to match AMIGA rawkey -tp */
#define XK_Home			61
#define XK_Left			79	/* Move left, left arrow */
#define XK_Up			76	/* Move up, up arrow */
#define XK_Right		78	/* Move right, right arrow */
#define XK_Down			77	/* Move down, down arrow */
...
/* modofied for amiga.. -tp */
#define XK_Shift_L		96	/* Left shift */
#define XK_Shift_R		97	/* Right shift */
#define XK_Control_L		99	/* Left control */
#define XK_Control_R		99	/* Right control */
#define XK_Caps_Lock		98	/* Caps lock */
#define XK_Shift_Lock		0xFFE6	/* Shift lock */

#define XK_Meta_L		102	/* Left meta */
#define XK_Meta_R		103	/* Right meta */
#define XK_Alt_L		100	/* Left alt */
#define XK_Alt_R		101	/* Right alt */
