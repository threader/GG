@DATABASE "gg:doc/NDK/Guide/Include/inline/strsup.h"
@MASTER   "gg:os-include/inline/strsup.h"
@REMARK   This file was created by ADtoHT 2.1 on 06-Jan-13 19:15:44
@REMARK   Do not edit
@REMARK   ADtoHT is © 1993-1995 Christian Stieber

@NODE MAIN "inline/strsup.h"
@TOC "gg:doc/NDK/Guide/TOC/MAIN"

@{"inline/strsup.h" LINK File}


@{b}#defines@{ub}

@{"strlen_plus_one()" LINK "gg:doc/NDK/Guide/Include/inline/strsup.h/File" 181}

@ENDNODE
@NODE File "inline/strsup.h"
...
extern __inline__ size_t @{"strlen_plus_one" LINK File 181}(const char *string)
{ const char *s=string;
...
extern __inline__ char *strchr(const char *s,int c)
{
  while (*s!=(char)c)
    if (!(*s++))
      return @{"NULL" LINK "gg:doc/NDK/Guide/Include/exec/types.h/File" 101};
  return (char *)s;
}
#endif
