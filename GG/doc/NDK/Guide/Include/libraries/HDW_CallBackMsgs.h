@DATABASE "gg:doc/NDK/Guide/Include/libraries/HDW_CallBackMsgs.h"
@MASTER   "gg:os-include/libraries/HDW_CallBackMsgs.h"
@REMARK   This file was created by ADtoHT 2.1 on 06-Jan-13 19:16:44
@REMARK   Do not edit
@REMARK   ADtoHT is © 1993-1995 Christian Stieber

@NODE MAIN "libraries/HDW_CallBackMsgs.h"
@TOC "gg:doc/NDK/Guide/TOC/MAIN"

@{"libraries/HDW_CallBackMsgs.h" LINK File}


@{b}#defines@{ub}

@{"HDW_CALLBACKMSGS_H" LINK "gg:doc/NDK/Guide/Include/libraries/HDW_CallBackMsgs.h/File" 154}  @{"MAX_MESSAGE" LINK "gg:doc/NDK/Guide/Include/libraries/HDW_CallBackMsgs.h/File" 150}

@ENDNODE
@NODE File "libraries/HDW_CallBackMsgs.h"
/*      HDW_CallBackMsgs.h
 *      Callback messages for the @{"hdwrench.library" LINK "gg:doc/NDK/Guide/hdwrench/MAIN"} tester program.
 *      These strings are "suggested" English strings for use with
 *      the @{"hdwrench.library" LINK "gg:doc/NDK/Guide/hdwrench/MAIN"} callback hook.
 *
...
char *callback_messages[] =
{
        ...
        "@{"Format" LINK "gg:doc/NDK/Guide/Include/inline/dos.h/File" 542} completed with no errors.",

        // L) FORMAT_FAILED_STRING                                              // 6 maybe
        "@{"Format" LINK "gg:doc/NDK/Guide/Include/inline/dos.h/File" 542} failed! Your drive may be dead.\\n",
        ...
        "Drive returned an Illegal @{"Request" LINK "gg:doc/NDK/Guide/Include/inline/intuition.h/File" 171} Error (%ld)\\n",
