@DATABASE "gg:doc/NDK/Guide/Include/devices/scsidisk.h"
@MASTER   "gg:os-include/devices/scsidisk.h"
@REMARK   This file was created by ADtoHT 2.1 on 06-Jan-13 19:12:40
@REMARK   Do not edit
@REMARK   ADtoHT is © 1993-1995 Christian Stieber

@NODE MAIN "devices/scsidisk.h"
@TOC "gg:doc/NDK/Guide/TOC/MAIN"

@{"devices/scsidisk.h" LINK File}


@{b}Structures@{ub}

@{"SCSICmd" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 93}


@{b}#defines@{ub}

@{"HD_SCSICMD" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 88}        @{"HD_WIDESCSI" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 87}      @{"HFERR_BadStatus" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 134}     @{"HFERR_DMA" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 130}
@{"HFERR_NoBoard" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 137}     @{"HFERR_Parity" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 132}     @{"HFERR_Phase" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 131}         @{"HFERR_SelfUnit" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 129}
@{"HFERR_SelTimeout" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 133}  @{"SCSIB_AUTOSENSE" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 125}  @{"SCSIB_OLDAUTOSENSE" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 126}  @{"SCSIB_READ_WRITE" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 118}
@{"SCSIF_AUTOSENSE" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 121}   @{"SCSIF_NOSENSE" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 120}    @{"SCSIF_OLDAUTOSENSE" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 123}  @{"SCSIF_READ" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 117}
@{"SCSIF_WRITE" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 116}       

@ENDNODE
@NODE File "devices/scsidisk.h"
 ...
 *
 *   UNIT NUMBERS
 *      Unit numbers to the @{"OpenDevice" LINK "gg:doc/NDK/Guide/exec/OpenDevice"} call have encoded in them which
...
#define HD_SCSICMD      28      /* issue a SCSI command to the unit */
                                ...
                                /* io_Length is sizeof(@{"struct SCSICmd" LINK "gg:doc/NDK/Guide/Include/devices/scsidisk.h/File" 93}) */
                                /* io_Actual and io_Offset are not used */

struct SCSICmd {
    @{"UWORD" LINK "gg:doc/NDK/Guide/Include/exec/types.h/File" 55}  *scsi_Data;          /* word aligned data for SCSI Data Phase */
                                /* (optional) data need not be byte aligned */
                                /* (optional) data need not be bus accessable */
    @{"ULONG" LINK "gg:doc/NDK/Guide/Include/exec/types.h/File" 52}   scsi_Length;        /* even length of Data area */
                                /* (optional) data can have odd length */
                                /* (optional) data length can be > 2**24 */
    @{"ULONG" LINK "gg:doc/NDK/Guide/Include/exec/types.h/File" 52}   scsi_Actual;        /* actual Data used */
    @{"UBYTE" LINK "gg:doc/NDK/Guide/Include/exec/types.h/File" 62}  *scsi_Command;       /* SCSI Command (same options as scsi_Data) */
    @{"UWORD" LINK "gg:doc/NDK/Guide/Include/exec/types.h/File" 55}   scsi_CmdLength;     /* length of Command */
    @{"UWORD" LINK "gg:doc/NDK/Guide/Include/exec/types.h/File" 55}   scsi_CmdActual;     /* actual Command used */
    @{"UBYTE" LINK "gg:doc/NDK/Guide/Include/exec/types.h/File" 62}   scsi_Flags;         /* includes intended data direction */
    @{"UBYTE" LINK "gg:doc/NDK/Guide/Include/exec/types.h/File" 62}   scsi_Status;        /* SCSI status of command */
    @{"UBYTE" LINK "gg:doc/NDK/Guide/Include/exec/types.h/File" 62}  *scsi_SenseData;     /* sense data: filled if SCSIF_[OLD]AUTOSENSE */
                                /* is set and scsi_Status has CHECK CONDITION */
                                /* (bit 1) set */
    @{"UWORD" LINK "gg:doc/NDK/Guide/Include/exec/types.h/File" 55}   scsi_SenseLength;   /* size of scsi_SenseData, also bytes to */
                                /* request w/ @{"SCSIF_AUTOSENSE" LINK File 121}, must be 4..255 */
    @{"UWORD" LINK "gg:doc/NDK/Guide/Include/exec/types.h/File" 55}   scsi_SenseActual;   /* amount actually fetched (0 means no sense) */
};
...
/*----- @{"OpenDevice" LINK "gg:doc/NDK/Guide/exec/OpenDevice"} io_Error values -----*/
