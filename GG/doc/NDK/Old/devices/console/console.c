;/* console.c - Execute me to compile me with Lattice 5.04
LC -b1 -cfistq -v -y -j73 console.c
Blink FROM LIB:c.o,console.o TO console LIBRARY LIB:LC.lib,LIB:Amiga.lib
quit
*/
