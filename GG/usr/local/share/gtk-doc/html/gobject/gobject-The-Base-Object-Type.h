...
</pre></div><div class="refsect1" lang="en"><a name="id2856861"></a><h2>Object Hierarchy</h2><pre class="synopsis">

  GObject
   +----<a href="GTypeModule.html" title="GTypeModule">GTypeModule</a>
</pre></div><div class="refsect1" lang="en"><a name="id2856880"></a><h2>Signal Prototypes</h2><pre class="synopsis">
...
</pre></div><div class="refsect1" lang="en"><a name="id2856931"></a><h2>Description</h2><p>

</p></div><div class="refsect1" lang="en"><a name="id2856941"></a><h2>Details</h2><div class="refsect2" lang="en"><a name="id2856946"></a><h3><a name="GObject-struct"></a>struct GObject</h3><a class="indexterm" name="id2856957"></a><pre class="programlisting">struct GObject;</pre><p>
...
</p></div><hr><div class="refsect2" lang="en"><a name="id2856985"></a><h3><a name="GObjectClass"></a>struct GObjectClass</h3><a class="indexterm" name="id2856996"></a><pre class="programlisting">struct GObjectClass {
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2857326"></a><h3><a name="GObjectConstructParam"></a>struct GObjectConstructParam</h3><a class="indexterm" name="id2857338"></a><pre class="programlisting">struct GObjectConstructParam {
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2857440"></a><h3><a name="GObjectGetPropertyFunc"></a>GObjectGetPropertyFunc ()</h3><a class="indexterm" name="id2857451"></a><pre class="programlisting">void        (*GObjectGetPropertyFunc)       (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             <a
href="../glib/glib-Basic-Types.html#guint"
>guint</a> property_id,
                                             <a href="gobject-Generic-values.html#GValue">GValue</a> *value,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2857612"></a><h3><a name="GObjectSetPropertyFunc"></a>GObjectSetPropertyFunc ()</h3><a class="indexterm" name="id2857623"></a><pre class="programlisting">void        (*GObjectSetPropertyFunc)       (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             <a
href="../glib/glib-Basic-Types.html#guint"
>guint</a> property_id,
                                             const <a href="gobject-Generic-values.html#GValue">GValue</a> *value,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2857777"></a><h3><a name="GObjectFinalizeFunc"></a>GObjectFinalizeFunc ()</h3><a class="indexterm" name="id2857789"></a><pre class="programlisting">void        (*GObjectFinalizeFunc)          (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2857857"></a><h3><a name="G-TYPE-IS-OBJECT-CAPS"></a>G_TYPE_IS_OBJECT()</h3><a class="indexterm" name="id2857869"></a><pre class="programlisting">#define G_TYPE_IS_OBJECT(type)      (G_TYPE_FUNDAMENTAL (type) == G_TYPE_OBJECT)
</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2857962"></a><h3><a name="G-OBJECT-CAPS"></a>G_OBJECT()</h3><a class="indexterm" name="id2857973"></a><pre class="programlisting">#define G_OBJECT(object)            (G_TYPE_CHECK_INSTANCE_CAST ((object), G_TYPE_OBJECT, GObject))
</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2858019"></a><h3><a name="G-IS-OBJECT-CAPS"></a>G_IS_OBJECT()</h3><a class="indexterm" name="id2858030"></a><pre class="programlisting">#define G_IS_OBJECT(object)         (G_TYPE_CHECK_INSTANCE_TYPE ((object), G_TYPE_OBJECT))
</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2858086"></a><h3><a name="G-OBJECT-CLASS-CAPS"></a>G_OBJECT_CLASS()</h3><a class="indexterm" name="id2858096"></a><pre class="programlisting">#define G_OBJECT_CLASS(class)       (G_TYPE_CHECK_CLASS_CAST ((class), G_TYPE_OBJECT, GObjectClass))
</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2858156"></a><h3><a name="G-IS-OBJECT-CLASS-CAPS"></a>G_IS_OBJECT_CLASS()</h3><a class="indexterm" name="id2858168"></a><pre class="programlisting">#define G_IS_OBJECT_CLASS(class)    (G_TYPE_CHECK_CLASS_TYPE ((class), G_TYPE_OBJECT))
</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2858232"></a><h3><a name="G-OBJECT-GET-CLASS-CAPS"></a>G_OBJECT_GET_CLASS()</h3><a class="indexterm" name="id2858243"></a><pre class="programlisting">#define G_OBJECT_GET_CLASS(object)  (G_TYPE_INSTANCE_GET_CLASS ((object), G_TYPE_OBJECT, GObjectClass))
</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2858294"></a><h3><a name="G-OBJECT-TYPE-CAPS"></a>G_OBJECT_TYPE()</h3><a class="indexterm" name="id2858305"></a><pre class="programlisting">#define G_OBJECT_TYPE(object)       (G_TYPE_FROM_INSTANCE (object))
</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2858356"></a><h3><a name="G-OBJECT-TYPE-NAME-CAPS"></a>G_OBJECT_TYPE_NAME()</h3><a class="indexterm" name="id2858368"></a><pre class="programlisting">#define G_OBJECT_TYPE_NAME(object)  (g_type_name (G_OBJECT_TYPE (object)))
</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2858421"></a><h3><a name="G-OBJECT-CLASS-TYPE-CAPS"></a>G_OBJECT_CLASS_TYPE()</h3><a class="indexterm" name="id2858432"></a><pre class="programlisting">#define G_OBJECT_CLASS_TYPE(class)  (G_TYPE_FROM_CLASS (class))
</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2858492"></a><h3><a name="G-OBJECT-CLASS-NAME-CAPS"></a>G_OBJECT_CLASS_NAME()</h3><a class="indexterm" name="id2858503"></a><pre class="programlisting">#define G_OBJECT_CLASS_NAME(class)  (g_type_name (G_OBJECT_CLASS_TYPE (class)))
</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2858563"></a><h3><a name="g-object-class-install-property"></a>g_object_class_install_property ()</h3><a class="indexterm" name="id2858575"></a><pre class="programlisting">void        g_object_class_install_property (<a href="gobject-The-Base-Object-Type.html#GObjectClass">GObjectClass</a> *oclass,
                                             <a
href="../glib/glib-Basic-Types.html#guint"
>guint</a> property_id,
                                             <a href="gobject-GParamSpec.html#GParamSpec">GParamSpec</a> *pspec);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2858683"></a><h3><a name="g-object-class-find-property"></a>g_object_class_find_property ()</h3><a class="indexterm" name="id2858695"></a><pre class="programlisting"><a href="gobject-GParamSpec.html#GParamSpec">GParamSpec</a>* g_object_class_find_property    (<a href="gobject-The-Base-Object-Type.html#GObjectClass">GObjectClass</a> *oclass,
                                             const <a
href="../glib/glib-Basic-Types.html#gchar"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2858806"></a><h3><a name="g-object-class-list-properties"></a>g_object_class_list_properties ()</h3><a class="indexterm" name="id2858817"></a><pre class="programlisting"><a href="gobject-GParamSpec.html#GParamSpec">GParamSpec</a>** g_object_class_list_properties (<a href="gobject-The-Base-Object-Type.html#GObjectClass">GObjectClass</a> *oclass,
                                             <a
href="../glib/glib-Basic-Types.html#guint"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2858922"></a><h3><a name="g-object-class-override-property"></a>g_object_class_override_property ()</h3><a class="indexterm" name="id2858934"></a><pre class="programlisting">void        g_object_class_override_property
                                            (<a href="gobject-The-Base-Object-Type.html#GObjectClass">GObjectClass</a> *oclass,
                                             <a
href="../glib/glib-Basic-Types.html#guint"
>guint</a> property_id,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2859152"></a><h3><a name="g-object-interface-install-property"></a>g_object_interface_install_property ()</h3><a class="indexterm" name="id2859165"></a><pre class="programlisting">void        g_object_interface_install_property
                                            (<a
href="../glib/glib-Basic-Types.html#gpointer"
>gpointer</a> g_iface,
                                             <a href="gobject-GParamSpec.html#GParamSpec">GParamSpec</a> *pspec);</pre><p>
...
</p></div><hr><div class="refsect2" lang="en"><a name="id2859301"></a><h3><a name="g-object-interface-find-property"></a>g_object_interface_find_property ()</h3><a class="indexterm" name="id2859313"></a><pre class="programlisting"><a href="gobject-GParamSpec.html#GParamSpec">GParamSpec</a>* g_object_interface_find_property
                                            (<a
href="../glib/glib-Basic-Types.html#gpointer"
>gpointer</a> g_iface,
                                             const <a
...
</p></div><hr><div class="refsect2" lang="en"><a name="id2859459"></a><h3><a name="g-object-interface-list-properties"></a>g_object_interface_list_properties ()</h3><a class="indexterm" name="id2859472"></a><pre class="programlisting"><a href="gobject-GParamSpec.html#GParamSpec">GParamSpec</a>** g_object_interface_list_properties
                                            (<a
href="../glib/glib-Basic-Types.html#gpointer"
>gpointer</a> g_iface,
                                             <a
...
</p></div><hr><div class="refsect2" lang="en"><a name="id2859608"></a><h3><a name="g-object-new"></a>g_object_new ()</h3><a class="indexterm" name="id2859619"></a><pre class="programlisting"><a
href="../glib/glib-Basic-Types.html#gpointer"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2859768"></a><h3><a name="g-object-newv"></a>g_object_newv ()</h3><a class="indexterm" name="id2859779"></a><pre class="programlisting"><a
href="../glib/glib-Basic-Types.html#gpointer"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2859938"></a><h3><a name="GParameter"></a>struct GParameter</h3><a class="indexterm" name="id2859949"></a><pre class="programlisting">struct GParameter {
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2860024"></a><h3><a name="g-object-ref"></a>g_object_ref ()</h3><a class="indexterm" name="id2860035"></a><pre class="programlisting"><a
href="../glib/glib-Basic-Types.html#gpointer"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2860110"></a><h3><a name="g-object-unref"></a>g_object_unref ()</h3><a class="indexterm" name="id2860121"></a><pre class="programlisting">void        g_object_unref                  (<a
href="../glib/glib-Basic-Types.html#gpointer"
>gpointer</a> object);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2860182"></a><h3><a name="GWeakNotify"></a>GWeakNotify ()</h3><a class="indexterm" name="id2860193"></a><pre class="programlisting">void        (*GWeakNotify)                  (<a
href="../glib/glib-Basic-Types.html#gpointer"
>gpointer</a> data,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2860283"></a><h3><a name="g-object-weak-ref"></a>g_object_weak_ref ()</h3><a class="indexterm" name="id2860294"></a><pre class="programlisting">void        g_object_weak_ref               (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             <a href="gobject-The-Base-Object-Type.html#GWeakNotify">GWeakNotify</a> notify,
                                             <a
href="../glib/glib-Basic-Types.html#gpointer"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2860417"></a><h3><a name="g-object-weak-unref"></a>g_object_weak_unref ()</h3><a class="indexterm" name="id2860428"></a><pre class="programlisting">void        g_object_weak_unref             (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             <a href="gobject-The-Base-Object-Type.html#GWeakNotify">GWeakNotify</a> notify,
                                             <a
href="../glib/glib-Basic-Types.html#gpointer"
>gpointer</a> data);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2860525"></a><h3><a name="g-object-add-weak-pointer"></a>g_object_add_weak_pointer ()</h3><a class="indexterm" name="id2860537"></a><pre class="programlisting">void        g_object_add_weak_pointer       (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             <a
href="../glib/glib-Basic-Types.html#gpointer"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2860644"></a><h3><a name="g-object-remove-weak-pointer"></a>g_object_remove_weak_pointer ()</h3><a class="indexterm" name="id2860656"></a><pre class="programlisting">void        g_object_remove_weak_pointer    (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             <a
href="../glib/glib-Basic-Types.html#gpointer"
>gpointer</a> *weak_pointer_location);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2860761"></a><h3><a name="g-object-connect"></a>g_object_connect ()</h3><a class="indexterm" name="id2860772"></a><pre class="programlisting"><a
href="../glib/glib-Basic-Types.html#gpointer"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2861091"></a><h3><a name="g-object-disconnect"></a>g_object_disconnect ()</h3><a class="indexterm" name="id2861102"></a><pre class="programlisting">void        g_object_disconnect             (<a
href="../glib/glib-Basic-Types.html#gpointer"
>gpointer</a> object,
                                             const <a
href="../glib/glib-Basic-Types.html#gchar"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2861215"></a><h3><a name="g-object-set"></a>g_object_set ()</h3><a class="indexterm" name="id2861226"></a><pre class="programlisting">void        g_object_set                    (<a
href="../glib/glib-Basic-Types.html#gpointer"
>gpointer</a> object,
                                             const <a
href="../glib/glib-Basic-Types.html#gchar"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2861324"></a><h3><a name="g-object-get"></a>g_object_get ()</h3><a class="indexterm" name="id2861334"></a><pre class="programlisting">void        g_object_get                    (<a
href="../glib/glib-Basic-Types.html#gpointer"
>gpointer</a> object,
                                             const <a
href="../glib/glib-Basic-Types.html#gchar"
...
</p><div class="example"><a name="id2861399"></a><p class="title"><b>Example 1. Using g_object_get()</b></p><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2861526"></a><h3><a name="g-object-notify"></a>g_object_notify ()</h3><a class="indexterm" name="id2861538"></a><pre class="programlisting">void        g_object_notify                 (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             const <a
href="../glib/glib-Basic-Types.html#gchar"
>gchar</a> *property_name);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2861632"></a><h3><a name="g-object-freeze-notify"></a>g_object_freeze_notify ()</h3><a class="indexterm" name="id2861644"></a><pre class="programlisting">void        g_object_freeze_notify          (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2861728"></a><h3><a name="g-object-thaw-notify"></a>g_object_thaw_notify ()</h3><a class="indexterm" name="id2861739"></a><pre class="programlisting">void        g_object_thaw_notify            (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2861811"></a><h3><a name="g-object-get-data"></a>g_object_get_data ()</h3><a class="indexterm" name="id2861822"></a><pre class="programlisting"><a
href="../glib/glib-Basic-Types.html#gpointer"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2861925"></a><h3><a name="g-object-set-data"></a>g_object_set_data ()</h3><a class="indexterm" name="id2861937"></a><pre class="programlisting">void        g_object_set_data               (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             const <a
href="../glib/glib-Basic-Types.html#gchar"
>gchar</a> *key,
                                             <a
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2862040"></a><h3><a name="g-object-set-data-full"></a>g_object_set_data_full ()</h3><a class="indexterm" name="id2862051"></a><pre class="programlisting">void        g_object_set_data_full          (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             const <a
href="../glib/glib-Basic-Types.html#gchar"
>gchar</a> *key,
                                             <a
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2862183"></a><h3><a name="g-object-steal-data"></a>g_object_steal_data ()</h3><a class="indexterm" name="id2862195"></a><pre class="programlisting"><a
href="../glib/glib-Basic-Types.html#gpointer"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2862288"></a><h3><a name="g-object-get-qdata"></a>g_object_get_qdata ()</h3><a class="indexterm" name="id2862300"></a><pre class="programlisting"><a
href="../glib/glib-Basic-Types.html#gpointer"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2862404"></a><h3><a name="g-object-set-qdata"></a>g_object_set_qdata ()</h3><a class="indexterm" name="id2862415"></a><pre class="programlisting">void        g_object_set_qdata              (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             <a
href="../glib/glib-Quarks.html#GQuark"
>GQuark</a> quark,
                                             <a
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2862571"></a><h3><a name="g-object-set-qdata-full"></a>g_object_set_qdata_full ()</h3><a class="indexterm" name="id2862582"></a><pre class="programlisting">void        g_object_set_qdata_full         (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             <a
href="../glib/glib-Quarks.html#GQuark"
>GQuark</a> quark,
                                             <a
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2862758"></a><h3><a name="g-object-steal-qdata"></a>g_object_steal_qdata ()</h3><a class="indexterm" name="id2862769"></a><pre class="programlisting"><a
href="../glib/glib-Basic-Types.html#gpointer"
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2862947"></a><h3><a name="g-object-set-property"></a>g_object_set_property ()</h3><a class="indexterm" name="id2862958"></a><pre class="programlisting">void        g_object_set_property           (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             const <a
href="../glib/glib-Basic-Types.html#gchar"
>gchar</a> *property_name,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2863056"></a><h3><a name="g-object-get-property"></a>g_object_get_property ()</h3><a class="indexterm" name="id2863068"></a><pre class="programlisting">void        g_object_get_property           (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             const <a
href="../glib/glib-Basic-Types.html#gchar"
>gchar</a> *property_name,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2863371"></a><h3><a name="g-object-set-valist"></a>g_object_set_valist ()</h3><a class="indexterm" name="id2863382"></a><pre class="programlisting">void        g_object_set_valist             (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             const <a
href="../glib/glib-Basic-Types.html#gchar"
>gchar</a> *first_property_name,
                                             va_list var_args);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2863487"></a><h3><a name="g-object-get-valist"></a>g_object_get_valist ()</h3><a class="indexterm" name="id2863498"></a><pre class="programlisting">void        g_object_get_valist             (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
                                             const <a
href="../glib/glib-Basic-Types.html#gchar"
>gchar</a> *first_property_name,
                                             va_list var_args);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2863644"></a><h3><a name="g-object-watch-closure"></a>g_object_watch_closure ()</h3><a class="indexterm" name="id2863656"></a><pre class="programlisting">void        g_object_watch_closure          (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2863806"></a><h3><a name="g-object-run-dispose"></a>g_object_run_dispose ()</h3><a class="indexterm" name="id2863818"></a><pre class="programlisting">void        g_object_run_dispose            (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *object);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id2863879"></a><h3><a name="G-OBJECT-WARN-INVALID-PROPERTY-ID-CAPS"></a>G_OBJECT_WARN_INVALID_PROPERTY_ID()</h3><a class="indexterm" name="id2863892"></a><pre class="programlisting">#define     G_OBJECT_WARN_INVALID_PROPERTY_ID(object, property_id, pspec)</pre><p>
...
</td></tr></tbody></table></div></div></div><div class="refsect1" lang="en"><a name="id2864018"></a><h2>Signals</h2><div class="refsect2" lang="en"><a name="id2864024"></a><h3><a name="GObject-notify"></a>The "notify" signal</h3><pre class="programlisting">void        user_function                  (<a href="gobject-The-Base-Object-Type.html#GObject">GObject</a> *gobject,
                                            <a href="gobject-GParamSpec.html#GParamSpec">GParamSpec</a> *arg1,
                                            <a
href="../glib/glib-Basic-Types.html#gpointer"
