...
</pre></div><div class="refsect1" lang="en"><a name="id3196143"></a><h2>Description</h2><p>

</p></div><div class="refsect1" lang="en"><a name="id3196153"></a><h2>Details</h2><div class="refsect2" lang="en"><a name="id3196159"></a><h3><a name="GShellError"></a>enum GShellError</h3><a class="indexterm" name="id3196170"></a><pre class="programlisting">typedef enum
{
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3196238"></a><h3><a name="G-SHELL-ERROR-CAPS"></a>G_SHELL_ERROR</h3><a class="indexterm" name="id3196249"></a><pre class="programlisting">#define G_SHELL_ERROR g_shell_error_quark ()
</pre><p>
...
error domains.
</p></div><hr><div class="refsect2" lang="en"><a name="id3196283"></a><h3><a name="g-shell-parse-argv"></a>g_shell_parse_argv ()</h3><a class="indexterm" name="id3196294"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gboolean">gboolean</a>    g_shell_parse_argv              (const <a href="glib-Basic-Types.html#gchar">gchar</a> *command_line,
                                             <a href="glib-Basic-Types.html#gint">gint</a> *argcp,
                                             <a href="glib-Basic-Types.html#gchar">gchar</a> ***argvp,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3196467"></a><h3><a name="g-shell-quote"></a>g_shell_quote ()</h3><a class="indexterm" name="id3196478"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gchar">gchar</a>*      g_shell_quote                   (const <a href="glib-Basic-Types.html#gchar">gchar</a> *unquoted_string);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3196560"></a><h3><a name="g-shell-unquote"></a>g_shell_unquote ()</h3><a class="indexterm" name="id3196571"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gchar">gchar</a>*      g_shell_unquote                 (const <a href="glib-Basic-Types.html#gchar">gchar</a> *quoted_string,
                                             <a href="glib-Error-Reporting.html#GError">GError</a> **error);</pre><p>
