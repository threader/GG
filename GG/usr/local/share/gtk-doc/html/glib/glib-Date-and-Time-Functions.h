...
</pre></div><div class="refsect1" lang="en"><a name="id3126836"></a><h2>Description</h2><p>
...
</p></div><div class="refsect1" lang="en"><a name="id3127092"></a><h2>Details</h2><div class="refsect2" lang="en"><a name="id3127098"></a><h3><a name="G-USEC-PER-SEC-CAPS"></a>G_USEC_PER_SEC</h3><a class="indexterm" name="id3127108"></a><pre class="programlisting">#define G_USEC_PER_SEC 1000000
</pre><p>
Number of microseconds in one second (1 million). This macro is provided for
code readability.
</p></div><hr><div class="refsect2" lang="en"><a name="id3127125"></a><h3><a name="GTimeVal"></a>struct GTimeVal</h3><a class="indexterm" name="id3127136"></a><pre class="programlisting">struct GTimeVal {
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3127215"></a><h3><a name="g-get-current-time"></a>g_get_current_time ()</h3><a class="indexterm" name="id3127227"></a><pre class="programlisting">void        g_get_current_time              (<a href="glib-Date-and-Time-Functions.html#GTimeVal">GTimeVal</a> *result);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3127295"></a><h3><a name="g-usleep"></a>g_usleep ()</h3><a class="indexterm" name="id3127306"></a><pre class="programlisting">void        g_usleep                        (<a href="glib-Basic-Types.html#gulong">gulong</a> microseconds);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3127375"></a><h3><a name="g-time-val-add"></a>g_time_val_add ()</h3><a class="indexterm" name="id3127386"></a><pre class="programlisting">void        g_time_val_add                  (<a href="glib-Date-and-Time-Functions.html#GTimeVal">GTimeVal</a> *time_,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3127490"></a><h3><a name="GDate"></a>struct GDate</h3><a class="indexterm" name="id3127500"></a><pre class="programlisting">struct GDate {
...
month, and year.
</p></div><hr><div class="refsect2" lang="en"><a name="id3125306"></a><h3><a name="GTime"></a>GTime</h3><a class="indexterm" name="id3125316"></a><pre class="programlisting">typedef gint32  GTime;
</pre><p>
...
</p></div><hr><div class="refsect2" lang="en"><a name="id3125345"></a><h3><a name="GDateDMY"></a>enum GDateDMY</h3><a class="indexterm" name="id3125356"></a><pre class="programlisting">typedef enum
{
  G_DATE_DAY   = 0,
  G_DATE_MONTH = 1,
  G_DATE_YEAR  = 2
...
</p></div><hr><div class="refsect2" lang="en"><a name="id3125373"></a><h3><a name="GDateDay"></a>GDateDay</h3><a class="indexterm" name="id3125384"></a><pre class="programlisting">typedef guint8  GDateDay;   /* day of the month */
</pre><p>
...
</p></div><hr><div class="refsect2" lang="en"><a name="id3127806"></a><h3><a name="GDateMonth"></a>enum GDateMonth</h3><a class="indexterm" name="id3127817"></a><pre class="programlisting">typedef enum
{
  G_DATE_BAD_MONTH = 0,
  G_DATE_JANUARY   = 1,
  G_DATE_FEBRUARY  = 2,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3128064"></a><h3><a name="GDateYear"></a>GDateYear</h3><a class="indexterm" name="id3128074"></a><pre class="programlisting">typedef guint16 GDateYear;
</pre><p>
...
</p></div><hr><div class="refsect2" lang="en"><a name="id3128101"></a><h3><a name="GDateWeekday"></a>enum GDateWeekday</h3><a class="indexterm" name="id3128112"></a><pre class="programlisting">typedef enum
{
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3128284"></a><h3><a name="G-DATE-BAD-DAY-CAPS"></a>G_DATE_BAD_DAY</h3><a class="indexterm" name="id3128295"></a><pre class="programlisting">#define G_DATE_BAD_DAY    0U
</pre><p>
Represents an invalid <a href="glib-Date-and-Time-Functions.html#GDateDay"><span class="type">GDateDay</span></a>.
</p></div><hr><div class="refsect2" lang="en"><a name="id3128318"></a><h3><a name="G-DATE-BAD-JULIAN-CAPS"></a>G_DATE_BAD_JULIAN</h3><a class="indexterm" name="id3128330"></a><pre class="programlisting">#define G_DATE_BAD_JULIAN 0U
</pre><p>
Represents an invalid Julian day number.
</p></div><hr><div class="refsect2" lang="en"><a name="id3128346"></a><h3><a name="G-DATE-BAD-YEAR-CAPS"></a>G_DATE_BAD_YEAR</h3><a class="indexterm" name="id3128358"></a><pre class="programlisting">#define G_DATE_BAD_YEAR   0U
</pre><p>
Represents an invalid year.
</p></div><hr><div class="refsect2" lang="en"><a name="id3128374"></a><h3><a name="g-date-new"></a>g_date_new ()</h3><a class="indexterm" name="id3128384"></a><pre class="programlisting"><a href="glib-Date-and-Time-Functions.html#GDate">GDate</a>*      g_date_new                      (void);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3128459"></a><h3><a name="g-date-new-dmy"></a>g_date_new_dmy ()</h3><a class="indexterm" name="id3128470"></a><pre class="programlisting"><a href="glib-Date-and-Time-Functions.html#GDate">GDate</a>*      g_date_new_dmy                  (<a href="glib-Date-and-Time-Functions.html#GDateDay">GDateDay</a> day,
                                             <a href="glib-Date-and-Time-Functions.html#GDateMonth">GDateMonth</a> month,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3128608"></a><h3><a name="g-date-new-julian"></a>g_date_new_julian ()</h3><a class="indexterm" name="id3128620"></a><pre class="programlisting"><a href="glib-Date-and-Time-Functions.html#GDate">GDate</a>*      g_date_new_julian               (<a href="glib-Basic-Types.html#guint32">guint32</a> julian_day);</pre><p>
Like <a href="glib-Date-and-Time-Functions.html#g-date-new"><tt class="function">g_date_new()</tt></a>, but also sets the value of the date. Assuming the
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3128704"></a><h3><a name="g-date-clear"></a>g_date_clear ()</h3><a class="indexterm" name="id3128715"></a><pre class="programlisting">void        g_date_clear                    (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3128806"></a><h3><a name="g-date-free"></a>g_date_free ()</h3><a class="indexterm" name="id3128817"></a><pre class="programlisting">void        g_date_free                     (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3128889"></a><h3><a name="g-date-set-day"></a>g_date_set_day ()</h3><a class="indexterm" name="id3128900"></a><pre class="programlisting">void        g_date_set_day                  (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3128985"></a><h3><a name="g-date-set-month"></a>g_date_set_month ()</h3><a class="indexterm" name="id3128996"></a><pre class="programlisting">void        g_date_set_month                (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3129081"></a><h3><a name="g-date-set-year"></a>g_date_set_year ()</h3><a class="indexterm" name="id3129092"></a><pre class="programlisting">void        g_date_set_year                 (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
                                             <a href="glib-Date-and-Time-Functions.html#GDateYear">GDateYear</a> year);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3129177"></a><h3><a name="g-date-set-dmy"></a>g_date_set_dmy ()</h3><a class="indexterm" name="id3129188"></a><pre class="programlisting">void        g_date_set_dmy                  (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
                                             <a href="glib-Date-and-Time-Functions.html#GDateDay">GDateDay</a> day,
                                             <a href="glib-Date-and-Time-Functions.html#GDateMonth">GDateMonth</a> month,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3129326"></a><h3><a name="g-date-set-julian"></a>g_date_set_julian ()</h3><a class="indexterm" name="id3129338"></a><pre class="programlisting">void        g_date_set_julian               (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3129422"></a><h3><a name="g-date-set-time"></a>g_date_set_time ()</h3><a class="indexterm" name="id3129434"></a><pre class="programlisting">void        g_date_set_time                 (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3129536"></a><h3><a name="g-date-set-parse"></a>g_date_set_parse ()</h3><a class="indexterm" name="id3129547"></a><pre class="programlisting">void        g_date_set_parse                (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3129652"></a><h3><a name="g-date-add-days"></a>g_date_add_days ()</h3><a class="indexterm" name="id3129663"></a><pre class="programlisting">void        g_date_add_days                 (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3129741"></a><h3><a name="g-date-subtract-days"></a>g_date_subtract_days ()</h3><a class="indexterm" name="id3129752"></a><pre class="programlisting">void        g_date_subtract_days            (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
                                             <a href="glib-Basic-Types.html#guint">guint</a> n_days);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3129830"></a><h3><a name="g-date-add-months"></a>g_date_add_months ()</h3><a class="indexterm" name="id3129841"></a><pre class="programlisting">void        g_date_add_months               (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3129921"></a><h3><a name="g-date-subtract-months"></a>g_date_subtract_months ()</h3><a class="indexterm" name="id3129932"></a><pre class="programlisting">void        g_date_subtract_months          (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
                                             <a href="glib-Basic-Types.html#guint">guint</a> n_months);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3130012"></a><h3><a name="g-date-add-years"></a>g_date_add_years ()</h3><a class="indexterm" name="id3130023"></a><pre class="programlisting">void        g_date_add_years                (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3130102"></a><h3><a name="g-date-subtract-years"></a>g_date_subtract_years ()</h3><a class="indexterm" name="id3130113"></a><pre class="programlisting">void        g_date_subtract_years           (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
                                             <a href="glib-Basic-Types.html#guint">guint</a> n_years);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3130193"></a><h3><a name="g-date-days-between"></a>g_date_days_between ()</h3><a class="indexterm" name="id3130205"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gint">gint</a>        g_date_days_between             (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date1,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3130309"></a><h3><a name="g-date-compare"></a>g_date_compare ()</h3><a class="indexterm" name="id3130320"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gint">gint</a>        g_date_compare                  (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *lhs,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3130438"></a><h3><a name="g-date-clamp"></a>g_date_clamp ()</h3><a class="indexterm" name="id3130449"></a><pre class="programlisting">void        g_date_clamp                    (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
                                             const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *min_date,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3130631"></a><h3><a name="g-date-order"></a>g_date_order ()</h3><a class="indexterm" name="id3130642"></a><pre class="programlisting">void        g_date_order                    (<a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date1,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3130724"></a><h3><a name="g-date-get-day"></a>g_date_get_day ()</h3><a class="indexterm" name="id3130734"></a><pre class="programlisting"><a href="glib-Date-and-Time-Functions.html#GDateDay">GDateDay</a>    g_date_get_day                  (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3130800"></a><h3><a name="g-date-get-month"></a>g_date_get_month ()</h3><a class="indexterm" name="id3130810"></a><pre class="programlisting"><a href="glib-Date-and-Time-Functions.html#GDateMonth">GDateMonth</a>  g_date_get_month                (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3130884"></a><h3><a name="g-date-get-year"></a>g_date_get_year ()</h3><a class="indexterm" name="id3130895"></a><pre class="programlisting"><a href="glib-Date-and-Time-Functions.html#GDateYear">GDateYear</a>   g_date_get_year                 (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3130968"></a><h3><a name="g-date-get-julian"></a>g_date_get_julian ()</h3><a class="indexterm" name="id3130980"></a><pre class="programlisting"><a href="glib-Basic-Types.html#guint32">guint32</a>     g_date_get_julian               (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3131056"></a><h3><a name="g-date-get-weekday"></a>g_date_get_weekday ()</h3><a class="indexterm" name="id3131067"></a><pre class="programlisting"><a href="glib-Date-and-Time-Functions.html#GDateWeekday">GDateWeekday</a> g_date_get_weekday             (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3131149"></a><h3><a name="g-date-get-day-of-year"></a>g_date_get_day_of_year ()</h3><a class="indexterm" name="id3131160"></a><pre class="programlisting"><a href="glib-Basic-Types.html#guint">guint</a>       g_date_get_day_of_year          (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3131226"></a><h3><a name="g-date-get-days-in-month"></a>g_date_get_days_in_month ()</h3><a class="indexterm" name="id3131238"></a><pre class="programlisting"><a href="glib-Basic-Types.html#guint8">guint8</a>      g_date_get_days_in_month        (<a href="glib-Date-and-Time-Functions.html#GDateMonth">GDateMonth</a> month,
                                             <a href="glib-Date-and-Time-Functions.html#GDateYear">GDateYear</a> year);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3131329"></a><h3><a name="g-date-is-first-of-month"></a>g_date_is_first_of_month ()</h3><a class="indexterm" name="id3131341"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gboolean">gboolean</a>    g_date_is_first_of_month        (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3131417"></a><h3><a name="g-date-is-last-of-month"></a>g_date_is_last_of_month ()</h3><a class="indexterm" name="id3131429"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gboolean">gboolean</a>    g_date_is_last_of_month         (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3131506"></a><h3><a name="g-date-is-leap-year"></a>g_date_is_leap_year ()</h3><a class="indexterm" name="id3131517"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gboolean">gboolean</a>    g_date_is_leap_year             (<a href="glib-Date-and-Time-Functions.html#GDateYear">GDateYear</a> year);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3131585"></a><h3><a name="g-date-get-monday-week-of-year"></a>g_date_get_monday_week_of_year ()</h3><a class="indexterm" name="id3131597"></a><pre class="programlisting"><a href="glib-Basic-Types.html#guint">guint</a>       g_date_get_monday_week_of_year  (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3131664"></a><h3><a name="g-date-get-monday-weeks-in-year"></a>g_date_get_monday_weeks_in_year ()</h3><a class="indexterm" name="id3131677"></a><pre class="programlisting"><a href="glib-Basic-Types.html#guint8">guint8</a>      g_date_get_monday_weeks_in_year (<a href="glib-Date-and-Time-Functions.html#GDateYear">GDateYear</a> year);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3131740"></a><h3><a name="g-date-get-sunday-week-of-year"></a>g_date_get_sunday_week_of_year ()</h3><a class="indexterm" name="id3131752"></a><pre class="programlisting"><a href="glib-Basic-Types.html#guint">guint</a>       g_date_get_sunday_week_of_year  (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3131820"></a><h3><a name="g-date-get-sunday-weeks-in-year"></a>g_date_get_sunday_weeks_in_year ()</h3><a class="indexterm" name="id3131832"></a><pre class="programlisting"><a href="glib-Basic-Types.html#guint8">guint8</a>      g_date_get_sunday_weeks_in_year (<a href="glib-Date-and-Time-Functions.html#GDateYear">GDateYear</a> year);</pre><p>
Returns the number of weeks in the year, where weeks are taken to start
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3131895"></a><h3><a name="g-date-strftime"></a>g_date_strftime ()</h3><a class="indexterm" name="id3131906"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gsize">gsize</a>       g_date_strftime                 (<a href="glib-Basic-Types.html#gchar">gchar</a> *s,
                                             <a href="glib-Basic-Types.html#gsize">gsize</a> slen,
                                             const <a href="glib-Basic-Types.html#gchar">gchar</a> *format,
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3132053"></a><h3><a name="g-date-to-struct-tm"></a>g_date_to_struct_tm ()</h3><a class="indexterm" name="id3132065"></a><pre class="programlisting">void        g_date_to_struct_tm             (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date,
                                             struct tm *tm);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3132157"></a><h3><a name="g-date-valid"></a>g_date_valid ()</h3><a class="indexterm" name="id3132168"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gboolean">gboolean</a>    g_date_valid                    (const <a href="glib-Date-and-Time-Functions.html#GDate">GDate</a> *date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3132270"></a><h3><a name="g-date-valid-day"></a>g_date_valid_day ()</h3><a class="indexterm" name="id3132281"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gboolean">gboolean</a>    g_date_valid_day                (<a href="glib-Date-and-Time-Functions.html#GDateDay">GDateDay</a> day);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3132350"></a><h3><a name="g-date-valid-month"></a>g_date_valid_month ()</h3><a class="indexterm" name="id3132362"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gboolean">gboolean</a>    g_date_valid_month              (<a href="glib-Date-and-Time-Functions.html#GDateMonth">GDateMonth</a> month);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3132438"></a><h3><a name="g-date-valid-year"></a>g_date_valid_year ()</h3><a class="indexterm" name="id3132450"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gboolean">gboolean</a>    g_date_valid_year               (<a href="glib-Date-and-Time-Functions.html#GDateYear">GDateYear</a> year);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3132526"></a><h3><a name="g-date-valid-dmy"></a>g_date_valid_dmy ()</h3><a class="indexterm" name="id3132537"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gboolean">gboolean</a>    g_date_valid_dmy                (<a href="glib-Date-and-Time-Functions.html#GDateDay">GDateDay</a> day,
                                             <a href="glib-Date-and-Time-Functions.html#GDateMonth">GDateMonth</a> month,
                                             <a href="glib-Date-and-Time-Functions.html#GDateYear">GDateYear</a> year);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3132658"></a><h3><a name="g-date-valid-julian"></a>g_date_valid_julian ()</h3><a class="indexterm" name="id3132669"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gboolean">gboolean</a>    g_date_valid_julian             (<a href="glib-Basic-Types.html#guint32">guint32</a> julian_date);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3132739"></a><h3><a name="g-date-valid-weekday"></a>g_date_valid_weekday ()</h3><a class="indexterm" name="id3132750"></a><pre class="programlisting"><a href="glib-Basic-Types.html#gboolean">gboolean</a>    g_date_valid_weekday            (<a href="glib-Date-and-Time-Functions.html#GDateWeekday">GDateWeekday</a> weekday);</pre><p>
