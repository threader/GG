...
</pre></div><div class="refsect1" lang="en"><a name="id3066212"></a><h2>Description</h2><p>
These functions provide support for outputting messages.
</p></div><div class="refsect1" lang="en"><a name="id3066222"></a><h2>Details</h2><div class="refsect2" lang="en"><a name="id3066228"></a><h3><a name="g-print"></a>g_print ()</h3><a class="indexterm" name="id3066238"></a><pre class="programlisting">void        g_print                         (const <a href="glib-Basic-Types.html#gchar">gchar</a> *format,
                                             ...);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3066379"></a><h3><a name="g-set-print-handler"></a>g_set_print_handler ()</h3><a class="indexterm" name="id3066390"></a><pre class="programlisting"><a href="glib-Warnings-and-Assertions.html#GPrintFunc">GPrintFunc</a>  g_set_print_handler             (<a href="glib-Warnings-and-Assertions.html#GPrintFunc">GPrintFunc</a> func);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3066461"></a><h3><a name="GPrintFunc"></a>GPrintFunc ()</h3><a class="indexterm" name="id3066472"></a><pre class="programlisting">void        (*GPrintFunc)                   (const <a href="glib-Basic-Types.html#gchar">gchar</a> *string);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3066520"></a><h3><a name="g-printerr"></a>g_printerr ()</h3><a class="indexterm" name="id3066531"></a><pre class="programlisting">void        g_printerr                      (const <a href="glib-Basic-Types.html#gchar">gchar</a> *format,
                                             ...);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3066664"></a><h3><a name="g-set-printerr-handler"></a>g_set_printerr_handler ()</h3><a class="indexterm" name="id3066675"></a><pre class="programlisting"><a href="glib-Warnings-and-Assertions.html#GPrintFunc">GPrintFunc</a>  g_set_printerr_handler          (<a href="glib-Warnings-and-Assertions.html#GPrintFunc">GPrintFunc</a> func);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3066747"></a><h3><a name="g-return-if-fail"></a>g_return_if_fail()</h3><a class="indexterm" name="id3066758"></a><pre class="programlisting">#define     g_return_if_fail(expr)</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3066802"></a><h3><a name="g-return-val-if-fail"></a>g_return_val_if_fail()</h3><a class="indexterm" name="id3066813"></a><pre class="programlisting">#define     g_return_val_if_fail(expr,val)</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3066881"></a><h3><a name="g-return-if-reached"></a>g_return_if_reached()</h3><a class="indexterm" name="id3066892"></a><pre class="programlisting">#define     g_return_if_reached()</pre><p>
Logs a critical message and returns from the current function. 
This can only be used in functions which do not return a value.
</p></div><hr><div class="refsect2" lang="en"><a name="id3066909"></a><h3><a name="g-return-val-if-reached"></a>g_return_val_if_reached()</h3><a class="indexterm" name="id3066921"></a><pre class="programlisting">#define     g_return_val_if_reached(val)</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3066961"></a><h3><a name="g-assert"></a>g_assert()</h3><a class="indexterm" name="id3066971"></a><pre class="programlisting">#define     g_assert(expr)</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3067022"></a><h3><a name="g-assert-not-reached"></a>g_assert_not_reached()</h3><a class="indexterm" name="id3067034"></a><pre class="programlisting">#define     g_assert_not_reached()</pre><p>
...
The macro can be turned off in final releases of code by defining
<span class="type">G_DISABLE_ASSERT</span> when compiling the application.
</p></div><hr><div class="refsect2" lang="en"><a name="id3067066"></a><h3><a name="g-on-error-query"></a>g_on_error_query ()</h3><a class="indexterm" name="id3067077"></a><pre class="programlisting">void        g_on_error_query                (const <a href="glib-Basic-Types.html#gchar">gchar</a> *prg_name);</pre><p>
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3067250"></a><h3><a name="g-on-error-stack-trace"></a>g_on_error_stack_trace ()</h3><a class="indexterm" name="id3067261"></a><pre class="programlisting">void        g_on_error_stack_trace          (const <a href="glib-Basic-Types.html#gchar">gchar</a> *prg_name);</pre><p>
Invokes <span><b class="command">gdb</b></span>, which attaches to the current process and shows a stack trace.
...
</td></tr></tbody></table></div></div><hr><div class="refsect2" lang="en"><a name="id3067381"></a><h3><a name="G-BREAKPOINT-CAPS"></a>G_BREAKPOINT()</h3><a class="indexterm" name="id3067392"></a><pre class="programlisting">#define     G_BREAKPOINT()</pre><p>
